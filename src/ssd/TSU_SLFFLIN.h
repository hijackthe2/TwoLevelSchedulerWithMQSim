#ifndef TSU_SLFFLIN_H
#define TSU_SLFFLIN_H
...
{
	class TSU_SLFFLIN : public TSU_Base
	{
	public:
		TSU_SLFFLIN(const sim_object_id_type& id, FTL* ftl, NVM_PHY_ONFI_NVDDR2* NVMController,
