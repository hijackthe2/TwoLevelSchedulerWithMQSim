#ifndef TSU_CLBFIFO_H
#define TSU_CLBFIFO_H
...
namespace SSD_Components
{
	...
	class TSU_CLBFIFO : public TSU_Base
	{
	public:
		TSU_CLBFIFO(const sim_object_id_type& id, FTL* ftl, NVM_PHY_ONFI_NVDDR2* NVMController, unsigned int Channel_no, unsigned int chip_no_per_channel,
