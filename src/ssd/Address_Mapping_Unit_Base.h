...
namespace SSD_Components
{
	...
	enum class Flash_Plane_Allocation_Scheme_Type
	{
		...
		EQCH, // assign the same number of channels for workloads
		FPFA, // free plane first allocation
		RCW, // round robin allocation for CW, DP is decided by CWDP
		RCWGDP, // round robin allocation for CW for each workload, global round-robin allocation for DP
	};
