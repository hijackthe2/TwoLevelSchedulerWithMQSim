#ifndef TSU_FUZZY_FLIN_H
#define TSU_FUZZY_FLIN_H
...
{
	class TSU_FuzzyFLIN : public TSU_Base
	{
	public:
		TSU_FuzzyFLIN(const sim_object_id_type& id, FTL* ftl, NVM_PHY_ONFI_NVDDR2* NVMController,
	...
	private:
		...
		bool is_low_intensity(unsigned int requests_recent, unsigned int alpha_for_epoch);
